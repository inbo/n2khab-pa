...
```{r mikado, fig.width=7, fig.height=9, fig.cap="Lijngrafiek voor opsporing van overeenkomsten en verschillen in het rangnummer van milieudrukken, volgens de verschillende scenario's."}
actie26_scores_kort %>% 
