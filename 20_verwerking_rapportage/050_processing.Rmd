...
We beschouwen twee scenario's om een goede bespreking op te kunnen baseren:
    - één scenario dat de nadruk legt op de noodzaak, bekeken vanuit de huidige problemen (milieu: vraagA1; beleidsinstrumenten: vraag B2b) om de instandhoudingsdoelstelling te bereiken (hoe hoger deze problematiek, hoe meer noodzakelijk);
...
actie26_rang %>% 
    ...
    arrange(Scenario_1) %>% 
    pandoc.table(
      caption = "(\\#tab:eindscores)Rangnummer van milieudrukken, gerangschikt volgens scenario 1.",
      split.table = Inf ,
     # split.cells = c(30,50),
     justify = "left"
    )
...
XXXXX Deze figuur is te bespreken als we dit er allemaal in houden. Bv. het zakken van 3.2P en 3.3P en het stijgen van o.a. 7.1, 7.3 en 5.2.
